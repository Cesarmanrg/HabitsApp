package dev.cmanrg.habitsapp.onboarding.di
...
import dev.cmanrg.habitsapp.onboarding.data.repository.OnboardingRepositoryImpl
import dev.cmanrg.habitsapp.onboarding.domain.repository.OnboardingRepository
import dev.cmanrg.habitsapp.onboarding.domain.usecase.CompleteOnboardingUseCase
...
object OnboardingModule {
    ...
    // Injectamos el SharedPreferences
    @Provides
    @Singleton
